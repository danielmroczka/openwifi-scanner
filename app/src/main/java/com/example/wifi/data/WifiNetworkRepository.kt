...
interface WifiNetworkRepository {
    ...
    suspend fun recordNetwork(bssid: String, ssid: String, latitude: Double? = null, longitude: Double? = null)
    suspend fun setBlacklisted(bssid: String, ssid: String, blacklisted: Boolean, latitude: Double? = null, longitude: Double? = null)
    suspend fun setWhitelisted(bssid: String, ssid: String, whitelisted: Boolean, latitude: Double? = null, longitude: Double? = null)
...
class RoomWifiNetworkRepository(private val dao: WifiNetworkDao) : WifiNetworkRepository {
    ...
    override suspend fun setBlacklisted(bssid: String, ssid: String, blacklisted: Boolean, latitude: Double?, longitude: Double?) {
    ...
    override suspend fun setWhitelisted(bssid: String, ssid: String, whitelisted: Boolean, latitude: Double?, longitude: Double?) {
        ensureExists(bssid, ssid, latitude, longitude)
    ...
    private suspend fun ensureExists(bssid: String, ssid: String, latitude: Double?, longitude: Double?) {
